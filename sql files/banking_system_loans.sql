...
CREATE TABLE `loans` (
  ...
  `type` enum('REGULAR','BALLOON') NOT NULL,
...
INSERT INTO `loans` VALUES (1,3,10000,'REGULAR','PENDING','2025-07-16',12,833.3333333333334,9500);
...
-- Dump completed on 2025-07-18  9:54:50
